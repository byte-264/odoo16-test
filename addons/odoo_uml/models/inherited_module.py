...
from .utils.plant_uml import  PlantUMLClassDiagram
from .utils.odoo_uml import InvPackageDiagram,PackageDiagram,ClassDiagram
...
class Module(models.Model):
    ...
    def _compute_diagrams(self):
        footer = _(
            ...
            ' //Author//: Armando Robert Lobo <mailto:softwareescarlata@gmail.com> '
        )
        for module in self:
            header = _('\n\n| **Module**: | {0} |\n| **Description**: | {1} |\n| **Author**: | {2} |\n').format(
                module.name,
