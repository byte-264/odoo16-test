odoo.define('dynamic_odoo.FormRenderer', function (require) {
    ...
    patch(ViewButton.prototype, 'studio.ViewButton', {
        ...
        get clickParams() {
            ...
            if (attrs && attrs.need_action && attrs.button_action) {
                const context = this.props.clickParams.context || {};
                context.BUTTON_ACTION = parseInt(attrs.button_action);
                this.props.clickParams.context = context;
            }
            return res;
        },
        getApprovalData() {
