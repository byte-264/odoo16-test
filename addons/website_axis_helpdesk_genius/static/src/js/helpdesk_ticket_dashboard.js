odoo.define('website_axis_helpdesk_genius.HelpdeskAction',  function (require) {
"use strict";
...
//            domain: [['attendee_ids.state','in',['declined']]],
     ...
     action_sla_complete_tickets:function(event){
        ...
        this.do_action({
            ...
            domain: [['helpdesk_stage_id.name','in',['Done'],['helpdesk_sla_deadline','<=',date_time]]],
            target: 'current'
        },)
     ...
     action_sla_pending_tickets:function(event){
        ...
        this.do_action({
            ...
            domain: [['helpdesk_stage_id.name','not in',['Done'],['helpdesk_sla_deadline','>=',date_time]]],
            target: 'current'
        },)
