...
class ResConfigSettings(models.TransientModel):
    ...
    is_attachment = fields.Boolean('Allow Attachment', default=False, config_parameter='website_axis_helpdesk_genius.is_attachment')
    ...
    manage_whatsapp_features = fields.Boolean('Helpdesk Whatsapp features ', default=False,implied_group='website_axis_helpdesk_genius.group_whatsapp')
