odoo.define('hr_attendance_controls_pro.GeofenceRenderer', function (require) {
    'use strict';
    ...
    var GeofenceRenderer = BasicRenderer.extend({        
        ...
        xmlDependencies: ['/hr_attendance_controls_pro/static/src/xml/geofence_template.xml'],
