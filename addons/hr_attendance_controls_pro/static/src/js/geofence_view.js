odoo.define('hr_attendance_controls_pro.GeofenceView', function (require) {
    'use strict';
    ...
    var GeofenceModel = require('hr_attendance_controls_pro.GeofenceModel');
    var GeofenceRenderer = require('hr_attendance_controls_pro.GeofenceRenderer');
    var GeofenceController = require('hr_attendance_controls_pro.GeofenceController');
