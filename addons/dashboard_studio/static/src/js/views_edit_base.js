odoo.define('dashboard_studio.views_edit_base', function (require) {
    ...
    var ViewContent = base.WidgetBase.extend({
        ...
        renderLegacyView: async function () {
            ...
            const viewContainer = await mount(ViewContainer, self.$el.find(".viewView").empty()[0],{
                env,
                templates,
            ...
            // }
            this.ref.viewContent = Object.values(viewContainer.__owl__.children)[0].childEnv.legacyRefs.widget;
        },
        ...
        renderTrendView: async function () {
            ...
            const props = {
                ...
                relatedModels: {[viewInfo.model]: fields},
                display: {
                    controlPanel: false,
                },
            ...
            // }
            const env = odoo.__WOWL_DEBUG__.root.env;
            const viewContainer = await mount(View, self.$el.find(".viewView").empty()[0],{
                env,
                templates,
                props: props,
                position: "first-child"
        ...
        destroy: function () {
            if (this.ref.viewContent && this.ref.viewContent.__owl__) {
                this.ref.viewContent.__owl__.destroy();
            }
        },
