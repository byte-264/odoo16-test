odoo.define('dashboard_studio.DashboardModify', function (require) {
    ...
    var MenuDialog = base.WidgetBase.extend({
        ...
        appendTo: function (container) {
            ...
            return this._super(container).then(() => {
                self.$el.css({
                    position: "fixed",
                    right: (windowWidth - width - left) + "px",
                    top: (top + height) + "px"
                });
            });
        },
    ...
    var DashboardCardAction = base.WidgetBase.extend({
        ...
        init: function (parent, params) {
            ...
            const {csv, pdf, png, jpg} = this.exports;
            this.action = {
                ...
                export_: {label: "Export", icon: "fa-download", children: [csv, pdf, png, jpg]},
        ...
        start: function () {
            ...
            const dashboardsCenter = new DashboardsCenter(this, {
                step: "setup", card: card, viewInfo: record.viewInfo,
        ...
        exportToExcel: function () {
            var {record} = this.props, view = this.parent.getViewContent(), dataSets = view.data.datasets,
                data = {
                    data: {
                        labels: ["Measure", ...view.data.labels.map((labels) => labels[0])],
        ...
        exportToImage: function (fileType) {
            const {record} = this.props, elCanvas = this.parent.$el.find("canvas"),
        ...
        onMoreAction: function (e) {
            ...
            const menuDialog = new MenuDialog(this, {
                menus: this.action, views: this.moreView,
    ...
    DashboardCard.include({
        ...
        getViewContent: function () {
            return this.ref.view.__owl__.controllerInst.__owl__.rendererInst.chart;
        ...
        renderView: function () {
            ...
            const cardActions = new DashboardCardAction(this, {
                ...this.props, moreView: moreView, actionView: actionView,
    ...
    DashboardController.include({
        onShowWidget: function (e) {
            ...
            const el = $(e.currentTarget),
                chooseWidget = new ChooseDashboardWidget(this, {view_id: this.viewInfo.view_id});
        ...
        init: function (parent, params) {
            ...
            this.components = {
                chart: {
                    ...
                    img: "/dashboard_studio/static/src/img/chart_icon.png"
                },
                title: {
                    label: "Title",
                    description: "Get a quick view to show Title",
                    img: "/dashboard_studio/static/src/img/number_icon.png"
                },
                battery: {
                    label: "Battery",
                    description: "Your progress in a glance",
                    img: "/dashboard_studio/static/src/img/battery_icon.png"
                },
                widgets_center: {
                    label: "Widgets Center",
                    description: "All the widgets you need in once place.",
                    img: "/dashboard_studio/static/src/img/widget_center.png"
                },
            }
        },
        start: function () {
