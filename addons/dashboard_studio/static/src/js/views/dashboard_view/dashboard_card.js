    ...
    var DashboardCard = base.WidgetBase.extend({
        ...
        init: function (parent, params) {
            ...
            this.widgets = {
                ...
                calendar: {render: () => this.renderTrendView.bind(this)()},
        ...
        renderViews: async function (_View) {
            ...
            if (record.viewInfo) {
                ...
                await mount(ViewContainer, self.$el.find(".wiContent")[0], {
                    env,
                    templates,
        ...
        getSearchParams: function () {
            const {viewInfo} = this.props.record,
                arch = typeof (viewInfo.arch) == "string" ? $(viewInfo.arch) : viewInfo.arch;
        ...
        destroy: function () {
            if (this.viewContainer) {
                this.viewContainer.__owl__.destroy();
            }
        },
        renderTrendView: async function () {
            ...
            if (record.viewInfo) {
                const props = {
                    ...
                    relatedModels: {[model]: fields},
                    loadActionMenus: false,
                    ...this.getSearchParams()
                }
                const env = odoo.__WOWL_DEBUG__.root.env;
                const viewContainer = await mount(View, self.$el.find(".wiContent")[0], {
                    // env,
